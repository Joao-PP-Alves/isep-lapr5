    ...
    public class FriendshipUnitTests{
        ...
        [TestInitialize]
         public void setup(){
            ...
            User user = new User(new Name("Joao"), new Email("email@gmail.com"),new Password(), new PhoneNumber("911197791"), new LifeDate(), list);
            User requester = new User(new Name("Janete"), new Email("janete@gmail.com"), new Password(), new PhoneNumber("965845254"), new LifeDate(), list);
